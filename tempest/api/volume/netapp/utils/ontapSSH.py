...
class NetappFiler:
    ...
    def create_volume(self, vserver, vol_name, source_aggr, vol_size='10GB',
                      mirror_aggr=None, dedup=False, compression=False,
                      thin=False, mirrored=False, mirror_vserver=None,
                      qosPolicy=None):
        """
